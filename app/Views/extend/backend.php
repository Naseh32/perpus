...
<head>
  ...
  <title>Perpus Digital &mdash; <?= $title ?></title>
      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand m-1" style="font-size:25px;">
            <a href="<?= base_url(); ?>"><i class="fas fa-book m-1" style="font-size:25px;"></i>Perpus Digital</a>
          </div>
          ...
          <ul class="sidebar-menu">
              ...
              <li class="nav-item dropdown">
                <a href="#" class="nav-link has-dropdown  <?php if($title == 'Data Petugas' OR $title == 'Tambah Petugas'){ ?> text-primary<?php }?>"><i class="fas fa-users"></i> <span>Admin</span></a>
                <ul class="dropdown-menu">
                  <li><a class="nav-link  <?php if($title == 'Data Petugas'){ ?> text-primary<?php }?>" href="<?= base_url(); ?>/admin/data-petugas">Data Admin</a></li>
                   <li><a class="nav-link <?php if($title == 'Tambah Petugas'){ ?> text-primary<?php }?>" href="<?= base_url(); ?>/admin/tambah-petugas">Tambah Admin</a></li>
                </ul>
              </li>
              <?php } ?>
              <?php if(session()->get('status') == 'Aktif') {?>
...
<?= $this->renderSection('content'); ?>
      ...
      <footer class="main-footer">
        <div class="footer-left">
          Copyright Community @2021<div class="bullet"></div> SMK Al-Manar
        </div>
