...
<nav class="navbar fixed-top navbar-d navbar-expand-lg py-3">
  <div class="container">
    ...
    <a class="navbar-brand text-dark justify-content-center" href="<?= base_url('/'); ?>"><i class="fa fa-book d-none d-md-inline-block"></i> Perpustakaan Digital</a>
    <div class="collapse navbar-collapse">
      <div class="navbar-nav ms-auto border-end border-1 border-primary nav-hover">
        <a class="text-decoration-none  mx-3 <?= ($title != 'Perpustakaan Digital | SMK Al-Manar') ? 'text-dark' : ' '; ?> " href="<?= base_url('/') ?>">HOME</a>
    ...
    <div class="navbar-nav">
      <?php if(session()->get('login') != 'Ya'){ ?>
        <a class="p-2 d-none d-md-inline-block" href="<?= base_url('login-admin') ?>"><button class="btn btn-primary">Masuk Admin</button></a>
        <a class="p-2 d-none d-md-inline-block" href="<?= base_url('login') ?>"><button class="btn btn-primary">Masuk</button></a>
...
<div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
  <div class="offcanvas-header bg-primary text-white">
      <h5 class="offcanvas-title" id="offcanvasExampleLabel">Perpustakaan Digital</h5>
...
<footer class="bg-white">
  <div class="container">
    <div class="row">
      <div class="col-sm-3">
        <h3><i class="fa fa-book pe-1"></i>Perpustakaan Digital</h3>
        <p>Perpustakaan Digital adalah website Perpustakaan Digital SMK Al-Manar yang memudahkan para siswa untuk meminjam buku hanya dengan sekali klik dan mengambilnya tinggal langsung data ke perpustkaan</p>
      </div>
      <div class="col-sm-3">
        <h4>Kategori</h4>
        <ul>
