        ...
        <div class="row">
          <div class="col-12 col-sm-10 col-md-6 col-lg-6 col-xl-6 header-register">
            ...
            <div class="card card-primary ">
              <div class="card-header"><h3>Daftar Anggota Perpustakaan Digital</h3></div>
              <div class="card-body">
                ...
                <form method="POST" action="<?= base_url('authF/daftarUser'); ?>" class="needs-validation" novalidate="">
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input id="kelas" type="text" class="form-control <?= ($validate->hasError('kelas')) ? 'is-invalid' : '' ; ?>" name="kelas" required>
                        <div class="invalid-feedback text-small">
                    ...
                    <div class="form-group">
                        ...
                        <input id="no_hp" type="text" class="form-control <?= ($validate->hasError('no_hp')) ? 'is-invalid' : '' ; ?>" name="no_hp" required>
                        <div class="invalid-feedback text-small">
                            <?= $validate->getError('no_hp'); ?>
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="foto">Foto</label>
                        <input id="foto" type="file" class="form-control <?= ($validate->hasError('foto')) ? 'is-invalid' : '' ; ?>" name="foto" required>
                        <div class="invalid-feedback text-small">
                            <?= $validate->getError('foto'); ?>
                        </div>
                    </div>
          ...
          <div class="col-md-6 d-none d-md-block">
              <h5>Mari Memulai dengan Perpustakaan Digital</h5>
