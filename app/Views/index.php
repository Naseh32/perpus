        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-5 col-sm-6 col-12 header-search">
                    <h1 class="text-center text-shadow text-white">Selamat datang di Perpustakaan Digital SMK Al-Manar</h1>
        ...
        <div class="container">
            <div class="row py-5">
                <div class="header-content col-md-7">
                    <p class="py-0 my-0">Perpustakaan Digital SMK Al-Manar</p>
                    <h1 class="text-primary">Meminjam buku Perpustakaan<br> dengan kemudahan</h1>
                    <p class="text-dark">Perpustakaan Digital adalah website Perpustakaan Digital SMK Al-Manar yang memberikan kemudahan kepada penggunanya, karena hanya dengan
